...
description: Gemini-native multi-model adversarial code review — iterative convergence loop for PRs and plans
capability: skill.hostile_reviewer
node_name: node_skill_hostile_reviewer_orchestrator
dot_color: 208
---
